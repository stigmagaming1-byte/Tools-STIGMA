...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const userToken = localStorage.getItem('cookieCheckerToken');
    const adminToken = localStorage.getItem('adminToken');

    if (adminToken) {
        // Redirect to admin dashboard if admin token exists
        window.location.href = 'admin.html';
    } else if (userToken) {
        // Redirect to user dashboard if user token exists
        window.location.href = 'index.html';
    }
