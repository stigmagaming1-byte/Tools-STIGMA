...
try:
    from api.global_logs import get_global_logs, get_global_results, get_global_stats
    GLOBAL_LOGS_ENABLED = True
except ImportError:
    GLOBAL_LOGS_ENABLED = False
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            elif path == '/api/admin/global_logs':
                if not GLOBAL_LOGS_ENABLED:
                    raise ValueError("Global logging is not enabled")
            ...
            elif path == '/api/admin/global_results':
                if not GLOBAL_LOGS_ENABLED:
                    raise ValueError("Global logging is not enabled")
