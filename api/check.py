    ...
    def do_POST(self):
        try:
            ...
            if action == 'start':
                ...
                try:
                    update_user_stats(username, 1)  # 1 cookie checked
                except Exception as e:
    ...
    if checker_state['is_checking']:
        ...
        if username:
            try:
                ...
                update_user_stats(username, total_checked)
                print(f"Updated stats for user {username}: {total_checked} cookies checked")
            except Exception as e:
